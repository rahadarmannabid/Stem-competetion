clc;
clear all;
close all;  %clean screen and variables to initial preparation
...
greentime=[0 10 10 15 15 15 15 5 5 8];
yellowtime=0;            % times (in second) for yellow light
exittime=1;           % times (in second) for each exit cars

entercar=5;             % #average of cars that enter to each street
exitcar=5;              % #cars that exit in each step from green light
